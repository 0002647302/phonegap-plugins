  ...
  public MultiFormatUPCEANReader(Hashtable hints) {
    ...
    if (possibleFormats != null) {
      if (possibleFormats.contains(BarcodeFormat.EAN_13)) {
        readers.addElement(new EAN13Reader(possibleFormats.contains(BarcodeFormat.UPC_EAN_EXTENSION)));
      } else if (possibleFormats.contains(BarcodeFormat.UPC_A)) {
        readers.addElement(new UPCAReader(possibleFormats.contains(BarcodeFormat.UPC_EAN_EXTENSION)));
      }
