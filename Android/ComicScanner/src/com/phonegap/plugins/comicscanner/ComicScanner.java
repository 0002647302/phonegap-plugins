...
package com.phonegap.plugins.comicscanner;
 ...
 */
public class ComicScanner extends Plugin {
    ...
    public void scan() {
         ...
         */
        Intent intentScan = new Intent("com.phonegap.plugins.comicscanner.SCAN");
        /* Custom barcode window
    ...
    public void encode(String type, String data) {
        Intent intentEncode = new Intent("com.phonegap.plugins.comicscanner.ENCODE");
