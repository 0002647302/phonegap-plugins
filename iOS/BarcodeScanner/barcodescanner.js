...
;(function(){ 
cordova.define("barcodeScanner", function(require, exports, module) 
{ 
...
BarcodeScanner.scan = function(success, fail, options) { 
...
BarcodeScanner.encode = function(type, data, success, fail, options) 
{ 
if (!fail) { fail = function() {}} 
if (typeof fail != "function")  { 
console.log("BarcodeScanner.scan failure: failure parameter not a function") 
